...
alter table scoring_sidbi.scoring_model add column bureau_version INT(2) DEFAULT 1;
alter table scoring_sidbi.scoring_model_temp add column bureau_version INT(2) DEFAULT 1;
