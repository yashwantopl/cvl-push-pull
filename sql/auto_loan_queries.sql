...
INSERT INTO `scoring_sidbi`.`field_master` (`id`,`name`, `type`, `created_date`, `modified_date`, `created_by`, `modified_by`, `is_active`, `parent_field_id`) VALUES(198,'LOAN_TO_INCOME_RATIO_AL','1','2019-05-25 18:09:05',NULL,NULL,NULL,TRUE,NULL);
...
INSERT INTO `scoring_sidbi`.`field_master` (`id`,`name`, `type`, `created_date`, `modified_date`, `created_by`, `modified_by`, `is_active`, `parent_field_id`) VALUES(200,'AVG_EOD_BALANCE_AL','1','2019-05-25 18:17:45',NULL,NULL,NULL,TRUE,NULL);
INSERT INTO `scoring_sidbi`.`field_master` (`id`,`name`, `type`, `created_date`, `modified_date`, `created_by`, `modified_by`, `is_active`, `parent_field_id`) VALUES(201,'CAR_SEGMENT_AL','2','2019-05-25 18:17:45',NULL,NULL,NULL,TRUE,NULL);
INSERT INTO `scoring_sidbi`.`field_master` (`id`,`name`, `type`, `created_date`, `modified_date`, `created_by`, `modified_by`, `is_active`, `parent_field_id`) VALUES(202,',SECURITY_COVERAGE_AL','1','2019-05-25 18:17:45',NULL,NULL,NULL,TRUE,NULL);
INSERT INTO `scoring_sidbi`.`field_master` (`id`,`name`, `type`, `created_date`, `modified_date`, `created_by`, `modified_by`, `is_active`, `parent_field_id`) VALUES(203,'TAKE_HOME_PAY_AL','1','2019-05-25 18:17:45',NULL,NULL,NULL,TRUE,NULL);	
...
insert into `scoring_sidbi`.`field_mapping` (`created_by`, `created_date`, `is_active`, `loan_type_id`, `modified_by`, `modified_date`, `field_master_id`, `business_type_id`, `financial_type_id`, `is_consider_co_app`, `employment_type_id`) values(NULL,'2019-05-25 18:17:45',TRUE,NULL,NULL,NULL,'200','8','3',TRUE,NULL);
insert into `scoring_sidbi`.`field_mapping` (`created_by`, `created_date`, `is_active`, `loan_type_id`, `modified_by`, `modified_date`, `field_master_id`, `business_type_id`, `financial_type_id`, `is_consider_co_app`, `employment_type_id`) values(NULL,'2019-05-25 18:17:45',TRUE,NULL,NULL,NULL,'201','8','3',FALSE,NULL);
insert into `scoring_sidbi`.`field_mapping` (`created_by`, `created_date`, `is_active`, `loan_type_id`, `modified_by`, `modified_date`, `field_master_id`, `business_type_id`, `financial_type_id`, `is_consider_co_app`, `employment_type_id`) values(NULL,'2019-05-25 18:17:45',TRUE,NULL,NULL,NULL,'202','8','3',FALSE,NULL);
insert into `scoring_sidbi`.`field_mapping` (`created_by`, `created_date`, `is_active`, `loan_type_id`, `modified_by`, `modified_date`, `field_master_id`, `business_type_id`, `financial_type_id`, `is_consider_co_app`, `employment_type_id`) values(NULL,'2019-05-25 18:17:45',TRUE,NULL,NULL,NULL,'203','8','3',FALSE,NULL);
