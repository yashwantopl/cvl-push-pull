...
25. INSERT INTO `loan_application`.`fs_corporate_cma_assets_details`
    	(
...
26. INSERT INTO `loan_application`.`fs_corporate_cma_liabilities_details`
	(
...
27. INSERT INTO `loan_application`.`fs_corporate_cma_operating_statement_details`
	(
