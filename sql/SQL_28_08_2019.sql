...
ALTER TABLE `loan_application`.`fs_mfi_bank_details` CHANGE `passbook_img` LONGTEXT NULL;
ALTER TABLE `loan_application`.`fs_mfi_applicant_details`  ADD COLUMN `total_emi` DOUBLE NULL AFTER `total_emi`;
