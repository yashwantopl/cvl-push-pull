CREATE TABLE `loan_application`.`auto_loan_model` (
  ...
  `is_personal_use` BIT(1) DEFAULT FALSE,
  `is_official_use` BIT(1) DEFAULT FALSE,
  `is_small_car` BIT(1) DEFAULT FALSE,
  `is_mid_car` BIT(1) DEFAULT FALSE,
  `is_luxury_car` BIT(1) DEFAULT FALSE,
  `is_suv_or_muv` BIT(1) DEFAULT FALSE,
  `is_electric_or_non_conventional_car` BIT(1) DEFAULT FALSE,
  `is_two_wheeler_loan` BIT(1) DEFAULT FALSE,
  `is_electric_or_non_conventional_two_wheeler` BIT(1) DEFAULT FALSE,
