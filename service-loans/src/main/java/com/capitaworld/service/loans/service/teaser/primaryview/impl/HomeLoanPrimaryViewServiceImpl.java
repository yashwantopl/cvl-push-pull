			...
			if (!CommonUtils.isObjectNullOrEmpty(loanDetail.getPropertyType())) {
				...
				if (!CommonUtils.isObjectNullOrEmpty(loanDetail.getPropertyType()) && loanDetail.getPropertyType() == 3) {
					...
					if (!CommonUtils.isObjectNullOrEmpty(loanDetail.getPropertyUsedType()) && loanDetail.getPropertyUsedType() == 3) {
						...
						if (!CommonUtils.isObjectNullOrEmpty(loanDetail.getIsConstructionCompleted())
								&& !loanDetail.getIsConstructionCompleted()) {
							homeLoanResponse.setConstructionCompletionTimeInMonth(
									!CommonUtils.isObjectNullOrEmpty(loanDetail.getConstructionCompletionTimeInMonth())
											? loanDetail.getConstructionCompletionTimeInMonth().toString() : "-");
							homeLoanResponse.setConstructionCompletionTimeInYear(
									!CommonUtils.isObjectNullOrEmpty(loanDetail.getConstructionCompletionTimeInYear())
											? loanDetail.getConstructionCompletionTimeInYear().toString() : "-");
						}
					}
