...
/**
 * The persistent class for the fs_corporate_board_of_directors_details database table.
 * 
 */
@Entity
@Table(name="fs_corporate_board_of_directors_details")
public class BoardOfDirectorsDetail implements Serializable {
