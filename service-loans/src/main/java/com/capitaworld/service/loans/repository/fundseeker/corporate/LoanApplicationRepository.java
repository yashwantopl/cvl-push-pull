...
//	 and lm.isActive = true
	...
	@Query("select lm from LoanApplicationMaster lm where lm.applicationStatusMaster.id >=:id and lm.npAssigneeId!=:npUserId and lm.npUserId=:npUserId lm.isActive = true ")
