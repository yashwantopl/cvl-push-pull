...
public enum BanksEnumForReports {
	...
	SARASWAT_BANK(2L ,"https://prod-sidbi-data.s3.ap-south-1.amazonaws.com/images/Saraswatbank.png","SRB","Saraswat Bank"),
	AXIS_BANK(3L ,null,"AXB","AXIS BANK"),
	ICICI_BANK(4L ,"https://s3.ap-south-1.amazonaws.com/prod-sidbi-data/images/icici.png","ICI","ICICI BANK"),
	...
	IDFC_BANK(8L ,"https://prod-sidbi-data.s3.ap-south-1.amazonaws.com/images/idfc-first-bank.png","IDFC","IDFC BANK"),
	
	DENA_BANK(9L ,"https://s3.ap-south-1.amazonaws.com/prod-sidbi-data/images/Dena+bank.png", "DB","DENA BANK"),
	...
	UCO_BANK(19L ,"https://prod-sidbi-data.s3.ap-south-1.amazonaws.com/images/UCObank.png", "UCO","UCO BANK"),
	PSB_BANK(20L ,"https://prod-sidbi-data.s3.ap-south-1.amazonaws.com/images/punjabandsindbank.png", "PSB","PSB BANK"),
	ORIENTAL_BANK_OF_COMMERCE(21L ,"https://s3.ap-south-1.amazonaws.com/prod-sidbi-data/images/obc+bank.png", "ORIENTAL","Oriental Bank Of Commerce"),
	SYNDICATE_BANK(22L ,"https://s3.ap-south-1.amazonaws.com/prod-sidbi-data/images/syndicate+bank.png", "Syndicate","Syndicate Bank"),
	ALLAHABAD_BANK(23L ,"https://s3.ap-south-1.amazonaws.com/prod-sidbi-data/images/allahabad+bank.png", "ALLAHABAD","Allahabad Bank"),
	CORPORATION_BANK(24L ,"https://prod-sidbi-data.s3.ap-south-1.amazonaws.com/images/Corporationbank.png", "CORPORATION","Corporation Bank"),
	CENTRAL_BANK(25L ,"https://prod-sidbi-data.s3.ap-south-1.amazonaws.com/images/central-bank-of-india-logo.png", "CENTRAL","Central Bank"),
	ANDHRA_BANK(26L ,"https://s3.ap-south-1.amazonaws.com/prod-sidbi-data/images/andhra+bank.png", "ANDHRA","Andhra Bank"),
	BANK_OF_MAHARASHTRA(27L ,"https://s3.ap-south-1.amazonaws.com/prod-sidbi-data/images/BOM.png", "MAHARASHTRA","Bank Of Maharashtra"),
	INDIAN_OVERSEAS_BANK(28L ,"https://prod-sidbi-data.s3.ap-south-1.amazonaws.com/images/indianoverseasbank.png", "IOB","Indian Overseas Bank"),
	UNITED_BANK_OF_INDIA(29L ,"https://s3.ap-south-1.amazonaws.com/prod-sidbi-data/images/united+bank+of+india.png", "UNITED","United Bank Of India"),
	KOTAK_BANK(30L ,"https://s3.ap-south-1.amazonaws.com/prod-sidbi-data/images/Kotek.png", "KOTAK","KOTAK BANK"),
	...
	HDFC_BANK(32L ,"https://s3.ap-south-1.amazonaws.com/prod-sidbi-data/images/HDFC.png", "HDFC","HDFC Bank"),
	ALRAEDAH_FINANCE(33L ,null, "ALRAEDAH FINANCE","ALRAEDAH FINANCE"),
	INDUSIND_BANK(34L ,null, "INDUSIND BANK","IndusInd Bank"),
	YES_BANK(35L ,null, "YES","YES Bank"),
	ELECTRONICA_FINANCE(36L ,"https://prod-sidbi-data.s3.ap-south-1.amazonaws.com/images/efl.jpg", "ELECTRONICA FINANCE","Electronica Finance"),
