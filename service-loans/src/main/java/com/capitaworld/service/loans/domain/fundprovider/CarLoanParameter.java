 ...
 */
@Entity
@Table(name="fp_car_loan_details")
public class CarLoanParameter extends ProductMaster implements Serializable {
	...
	@Column(name="car_loan_type_id")
	private Integer carLoanTypeId;
	...
	@Column(name="is_car_loan_type_display")
	private Boolean isCarLoanTypeDisplay=false;

	@Column(name="is_car_loan_type_mandatory")
	private Boolean isCarLoanTypeMandatory=false;
	...
	public Integer getCarLoanTypeId() {
		return carLoanTypeId;
	}

	public void setCarLoanTypeId(Integer carLoanTypeId) {
		this.carLoanTypeId = carLoanTypeId;
	}
	...
	public Boolean getIsCarLoanTypeDisplay() {
		return isCarLoanTypeDisplay;
	}

	public void setIsCarLoanTypeDisplay(Boolean isCarLoanTypeDisplay) {
		this.isCarLoanTypeDisplay = isCarLoanTypeDisplay;
	}

	public Boolean getIsCarLoanTypeMandatory() {
		return isCarLoanTypeMandatory;
	}

	public void setIsCarLoanTypeMandatory(Boolean isCarLoanTypeMandatory) {
		this.isCarLoanTypeMandatory = isCarLoanTypeMandatory;
	}
