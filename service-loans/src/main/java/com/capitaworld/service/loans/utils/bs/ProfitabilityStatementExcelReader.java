...
public class ProfitabilityStatementExcelReader
{
    ...
    public static void run(Long storageDetailsId,XSSFSheet sheet,LoanApplicationMaster loanApplicationMaster,ProfitibilityStatementDetailRepository profitibilityStatementDetailRepository)
    {
         ...
         */
        extractCellFromSheet(storageDetailsId,sheet,loanApplicationMaster, profitabilityStatementMappingList, "C","2014",profitibilityStatementDetailRepository);
        extractCellFromSheet(storageDetailsId,sheet,loanApplicationMaster, profitabilityStatementMappingList, "D","2015",profitibilityStatementDetailRepository);
        extractCellFromSheet(storageDetailsId,sheet,loanApplicationMaster, profitabilityStatementMappingList, "E","2016",profitibilityStatementDetailRepository);
        extractCellFromSheet(storageDetailsId,sheet,loanApplicationMaster, profitabilityStatementMappingList, "F","2017",profitibilityStatementDetailRepository);
        extractCellFromSheet(storageDetailsId,sheet,loanApplicationMaster, profitabilityStatementMappingList, "G","2018",profitibilityStatementDetailRepository);
        extractCellFromSheet(storageDetailsId,sheet,loanApplicationMaster, profitabilityStatementMappingList, "H","2019",profitibilityStatementDetailRepository);
        extractCellFromSheet(storageDetailsId,sheet,loanApplicationMaster, profitabilityStatementMappingList, "I","2020",profitibilityStatementDetailRepository);
        extractCellFromSheet(storageDetailsId,sheet,loanApplicationMaster, profitabilityStatementMappingList, "J","2021",profitibilityStatementDetailRepository);
        extractCellFromSheet(storageDetailsId,sheet,loanApplicationMaster, profitabilityStatementMappingList, "K","2022",profitibilityStatementDetailRepository);
        extractCellFromSheet(storageDetailsId,sheet,loanApplicationMaster, profitabilityStatementMappingList, "L","2023",profitibilityStatementDetailRepository);
        extractCellFromSheet(storageDetailsId,sheet,loanApplicationMaster, profitabilityStatementMappingList, "M","2024",profitibilityStatementDetailRepository);
        extractCellFromSheet(storageDetailsId,sheet,loanApplicationMaster, profitabilityStatementMappingList, "N","2025",profitibilityStatementDetailRepository);

    }

    public static void extractCellFromSheet(Long storageDetailsId,XSSFSheet sheet,LoanApplicationMaster loanApplicationMaster,ArrayList arrayList,String column,String year,ProfitibilityStatementDetailRepository profitibilityStatementDetailRepository)
    {
        int nullCounter = 0;
