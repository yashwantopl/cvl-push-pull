...
/**
 * The persistent class for the fs_corporate_key_management_details database table.
 * 
 */
@Entity
@Table(name="fs_corporate_key_management_details")
@NamedQuery(name="KeyManagementDetail.findAll", query="SELECT k FROM KeyManagementDetail k")
public class KeyManagementDetail implements Serializable {
	...
	@Column(name="any_special_achievement")
	...
	public String getAnySpecialAchievement() {
		return this.anySpecialAchievement;
	}
