...
public class MeansOfFinanceDetailController {

	private static final Logger logger = LoggerFactory.getLogger(MeansOfFinanceDetailController.class);
	...
	public ResponseEntity<LoansResponse> save(@RequestBody FrameRequest frameRequest, HttpServletRequest request,@RequestParam(value = "clientId", required = false) Long clientId) {
		...
		try {
			...
			meansOfFinanceDetailService.saveOrUpdate(frameRequest);
