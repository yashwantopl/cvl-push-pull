...
//			Boolean primaryLocked = loanApplicationService.isFinalLocked(applicationId, finalUserId);
	...
	public ResponseEntity<LoansResponse> getListCoApplicant(@PathVariable Long id, @PathVariable Long proposalId,@PathVariable Long coAppId,
		...
		try {
			...
			List<OtherCurrentAssetDetailRequest> response = otherCurrentAssetDetailService
					.getOtherCurrentAssetDetailListByProposalIdAndCoAppId(proposalId, coAppId);
			LoansResponse loansResponse = new LoansResponse("Data Found.", HttpStatus.OK.value());
			loansResponse.setListData(response);
			Integer currencyId = null;
			Long applicantIdById = null;
	...
	public ResponseEntity<LoansResponse> getList(@PathVariable Long id, @PathVariable Long proposalId, @PathVariable int applicationType,
			@RequestParam(value = "clientId", required = false) Long clientId, HttpServletRequest request) {
		// request must not be null
		try {
			Long userId = null;
			...
			List<OtherCurrentAssetDetailRequest> response = otherCurrentAssetDetailService
					.getOtherCurrentAssetDetailListByProposalId(proposalId, applicationType);
			LoansResponse loansResponse = new LoansResponse("Data Found.", HttpStatus.OK.value());
			loansResponse.setListData(response);
			Integer currencyId = null;
			Long applicantIdById = null;
...
//			Boolean primaryLocked = loanApplicationService.isFinalLocked(applicationId, finalUserId);
			...
			otherCurrentAssetDetailService.saveOrUpdateCoApplicant(frameRequest);
			return new ResponseEntity<LoansResponse>(new LoansResponse("Successfully Saved.", HttpStatus.OK.value()),
					HttpStatus.OK);
