...
/**
 * The persistent class for the fs_corporate_capacity_details database table.
 * 
 */
@Entity
@Table(name="fs_corporate_capacity_details")
@NamedQuery(name="CapacityDetail.findAll", query="SELECT c FROM CapacityDetail c")
public class CapacityDetail implements Serializable {
	...
	@Column(name="current_installed_capacity")
	private String currentInstalledCapacity;

	@Column(name="current_operating_level")
	...
	@Column(name="measurement_for_current_installed_capacity")
	private String measurementForCurrentInstalledCapacity;

	@Column(name="measurement_for_future_capacity")
	...
	public String getCurrentInstalledCapacity() {
		return this.currentInstalledCapacity;
	}
	...
	public String getCurrentOperatingLevel() {
		return this.currentOperatingLevel;
	}
	...
	public String getMeasurementForCurrentInstalledCapacity() {
		return this.measurementForCurrentInstalledCapacity;
	}
	...
	public String getMeasurementForFutureCapacity() {
		return this.measurementForFutureCapacity;
	}
