...
public interface DDRFormDetailsRepository extends JpaRepository<DDRFormDetails, Long>{
	...
	@Query("select ddr from DDRFormDetails ddr where ddr.id =:id and ddr.proposalMappingId =:proposalId and ddr.applicationId=:applicationId and  and ddr.isActive = true")
	...
	public DDRFormDetails getByProposaMappingIdAndApplicationId(@Param("proposalId") Long proposalId,@Param("applicationId") Long applicationId);
