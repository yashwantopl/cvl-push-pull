	...
	public List<NhbsApplicationsResponse> getListOfProposalsFP(NhbsApplicationRequest request,Long npOrgId,Long userId) {
		...
		if(!CommonUtils.isListNullOrEmpty(proposalIdList)){
			for (BigInteger proposalId : proposalIdList) {
				...
				} else if(CommonUtils.BusinessType.RETAIL_PERSONAL_LOAN.getId().equals(applicationProposalMapping.getBusinessTypeId()) || BusinessType.RETAIL_HOME_LOAN.getId().equals(applicationProposalMapping.getBusinessTypeId()) || CommonUtils.BusinessType.RETAIL_AUTO_LOAN.getId().equals(applicationProposalMapping.getBusinessTypeId())){
	...
	public List<NhbsApplicationsResponse> getListOfCheckerProposalsFP(NhbsApplicationRequest request) {
		...
		if(!CommonUtils.isListNullOrEmpty(applicationIdList)) {
			...
			for (BigInteger proposalId : applicationIdList) {
				...
				} else if (proposalMapping.getBusinessTypeId().equals(CommonUtils.BusinessType.RETAIL_PERSONAL_LOAN.getId()) || proposalMapping.getBusinessTypeId().equals(BusinessType.RETAIL_HOME_LOAN.getId())) {
...
//						(proposalMapping.getDdrStatusId() >= CommonUtils.DdrStatus.SUBMITTED)) {
	...
	public List<NhbsApplicationsResponse> getListOfCheckerMFIProposalsFP(NhbsApplicationRequest request) {
		...
		List<BigInteger> applicationIdList = new ArrayList<>();

		List<Long> proposalStatusList = new ArrayList<>();
		...
		if(com.capitaworld.service.users.utils.CommonUtils.UserRoles.MFI_CHECKER== request.getUserRoleId()){
			...
			}else if(request.getDdrStatusId()==CommonUtils.MFIApplicationStatus.MFI_Sanction
