...
@RestController
@RequestMapping("/unsecured_guarantors_details")
public class UnsecuredGuarantorsDetailController {

	private static final Logger logger = LoggerFactory.getLogger(UnsecuredGuarantorsDetailController.class);

	@Autowired
	private UnsecuredGuarantorDetailService unsecuredGuarantorsDetailService;
	...
	public ResponseEntity<LoansResponse> save(@RequestBody FrameRequest frameRequest, HttpServletRequest request,@RequestParam(value = "clientId",required = false) Long clientId) {
		...
		try {
			...
			unsecuredGuarantorsDetailService.saveOrUpdate(frameRequest);
	...
	public ResponseEntity<LoansResponse> getList(@PathVariable Long id, HttpServletRequest request,@RequestParam(value = "clientId",required = false) Long clientId) {
		...
		try {
			...
			List<UnsecuredGuarantorDetailRequest> response = unsecuredGuarantorsDetailService
