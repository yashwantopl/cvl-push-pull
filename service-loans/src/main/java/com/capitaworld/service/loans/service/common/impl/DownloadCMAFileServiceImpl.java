	...
	public Workbook cmaFileGenerator(Long applicationId , Long productDocumentMappingId) {
		...
		try {
			...
			for (AssetsDetails assetsDetails : assetsDetailsList) {
				...
				sheet3.getRow(46).getCell(j).setCellValue(assetsDetails.getGrossBlock1());
				sheet3.getRow(46).getCell(j).setCellValue(assetsDetails.getGrossBlock2());
				sheet3.getRow(46).getCell(j).setCellValue(assetsDetails.getGrossBlock3());
				sheet3.getRow(46).getCell(j).setCellValue(assetsDetails.getGrossBlock4());
