...
public interface MfiApplicationDetailsRepository extends JpaRepository<MFIApplicantDetail,Long> {
    ...
    @Query("select new com.capitaworld.service.loans.model.micro_finance.MfiLoanAssessmentDetailsReq(fn.applicationId.id,fn.purposeOfLoan,fn.clientType,fn.isBusinessPremiseVisited,fn.repaymentTrack,fn.creaditWorthiness,fn.loanLiabilityRatio,fn.competition) from MFIApplicantDetail fn where fn.applicationId.id = :appId and fn.isActive = true")
