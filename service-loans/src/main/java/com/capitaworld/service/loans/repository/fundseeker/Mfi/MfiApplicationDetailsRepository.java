...
public interface MfiApplicationDetailsRepository extends JpaRepository<MFIApplicantDetail,Long> {
    ...
    @Query("select new com.capitaworld.service.loans.model.micro_finance.MfiIncomeAndExpenditureReq(fn.applicationId.id,me.shipShgiInstallment,me.otherInstallment,me.loanInstallment,me.educationExpense,me.medicalExpense,me.foodExpense,me.otherExpense,me.businessInBrief,me.monthlyCashflow,me.monthlyExpenditure,me.monthlyIncome,fn.ppiNoFamilyMember,fn.ppiAcadamicHeadFamily,fn.ppiRafrigeratorInFamily,fn.ppiStoveInFamily,fn.ppiPressureCookerInFamily,fn.ppiTvInFamily,fn.ppiFanInFamily,fn.ppiVehicleInFamily,fn.ppiDressingTableInFamily,fn.ppiOtherTableInFamily,me.houseHoldExpense,me.clothesExpense) from MFIApplicantDetail fn, MfiExpenseExpectedIncomeDetails me where me.applicationId = fn.applicationId.id  and fn.applicationId.id = :appId and fn.isActive = true and me.type =:type")
	public List<MfiIncomeAndExpenditureReq> findIncomeAndExpenditureDetailsByAppId(@Param("appId") Long appId,@Param("type") Integer type);
