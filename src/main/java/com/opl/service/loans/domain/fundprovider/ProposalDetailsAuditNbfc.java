 ...
 */
@Entity
@Table(name="proposal_details_audit_nbfc")
@NamedQuery(name="ProposalDetailsAuditNbfc.findAll", query="SELECT p FROM ProposalDetailsAuditNbfc p")
public class ProposalDetailsAuditNbfc implements Serializable {
