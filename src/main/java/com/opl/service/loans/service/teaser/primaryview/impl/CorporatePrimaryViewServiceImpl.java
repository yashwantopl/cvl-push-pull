				...
				try {
					...
					if(directorBackgroundDetailRequest.getIsMainDirector() != null && directorBackgroundDetailRequest.getIsMainDirector() == true){
						...
						if(directorBackgroundDetailRequest.getDirectorPersonalDetailRequest() != null) {
							...
							directorPersonalDetail.setHaveOwnCommercialProperty(directorBackgroundDetailRequest.getDirectorPersonalDetailRequest().getIsWorkAndResidenceSamePlace() != null ?(directorBackgroundDetailRequest.getDirectorPersonalDetailRequest().getIsWorkAndResidenceSamePlace().equals(1) ? "Yes" : "No")  : "-"  );
