...
import com.opl.service.loans.domain.fundseeker.corporate.EmploymentDetail;
...
import com.opl.service.loans.repository.fundseeker.corporate.EmploymentDetailRepository;
...
import com.opl.service.loans.service.fundseeker.corporate.NTBService;
            ...
            try {
                for (DirectorBackgroundDetailRequest reqObj : directorBackgroundDetailRequestList) {
                    ...
                    if (!CommonUtils.isObjectNullOrEmpty(reqObj.getId())) {
                        ...
                        BeanUtils.copyProperties(reqObj, saveDirObj, "id", CommonUtils.CREATED_BY, CommonUtils.CREATED_DATE, CommonUtils.MODIFIED_BY,CommonUtils.MODIFIED_DATE);
