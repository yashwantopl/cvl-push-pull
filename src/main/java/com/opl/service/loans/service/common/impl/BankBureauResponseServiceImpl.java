...
import com.opl.service.loans.repository.common.BankBureauResponseRepository;
...
public class BankBureauResponseServiceImpl implements BankBureauResponseService {
	...
	public boolean inActiveAndsaveScoring(BankBureauRequest bankBureauRequest) {
		Integer inactiveByType = bankBureauResponseRepository.inactiveByAppAndScoringModelAndFieldMasterIdAndType(bankBureauRequest.getApplicationId(), bankBureauRequest.getScoringModelId(), bankBureauRequest.getFieldMasterId(), com.opl.mudra.api.matchengine.utils.CommonUtils.BankBureauResponseType.SCORING.getId());
