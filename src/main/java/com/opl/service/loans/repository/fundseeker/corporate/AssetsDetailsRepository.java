...
public interface AssetsDetailsRepository extends JpaRepository<AssetsDetails, Long> {
	...
	@Query("select o from AssetsDetails o where o.loanApplicationMaster.id = :applicationId and o.year = :yr and o.isActive = true and o.applicationProposalMapping.proposalId IS NULL")
