...
public interface BoardOfDirectorsDetailRepository extends JpaRepository<BoardOfDirectorsDetail, Long> {
	...
	@Query("select new com.opl.mudra.api.loans.model.teaser.finalview.BoardOfDirectorsResponse(a.anySpecialAchievement,a.designation,a.experience,a.functionalDuties,a.name,a.qualification) from BoardOfDirectorsDetail a where a.applicationId.id= :applicationId and isActive=true")
