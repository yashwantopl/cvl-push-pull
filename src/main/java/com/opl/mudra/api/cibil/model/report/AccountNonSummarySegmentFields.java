...
public class AccountNonSummarySegmentFields implements Serializable
{
    ...
    private Integer dateOpenedOrDisbursed;
     ...
     * @param amountOverdue
     */
    public AccountNonSummarySegmentFields(Integer paymentHistory2FieldLength, Integer dateOpenedOrDisbursed, Long currentBalance, String paymentHistoryEndDate, String reportingMemberShortName, String paymentHistory2, Integer reportingMemberShortNameFieldLength, String accountType, String highCreditOrSanctionedAmountFieldLength, String paymentHistory1, String dateReportedAndCertified, String currentBalanceFieldLength, String dateOfLastPayment, String dateClosed, Integer owenershipIndicator, String paymentHistory1FieldLength, String paymentHistoryStartDate, Long highCreditOrSanctionedAmount, Integer writtenOffAmountPrincipal, String settlementAmountFieldLength, Long writtenOffAmountTotal, String writtenOffAmountPrincipalFieldLength, Long settlementAmount, Long creditLimit, String paymentFrequency, String creditLimitFieldLength, String writtenOffAndSettled, String writtenOffAmountTotalFieldLength,Integer emiAmount,Double rateOfInterest,Integer repaymentTenure,Integer repaymentTenureFieldLength,Double amountOverdue,String suitFiledOrWilfulDefault) {
        super();
    ...
    @JsonProperty("DateOpenedOrDisbursed")
    public Integer getDateOpenedOrDisbursed() {
        return dateOpenedOrDisbursed;
    }

    @JsonProperty("DateOpenedOrDisbursed")
    public void setDateOpenedOrDisbursed(Integer dateOpenedOrDisbursed) {
        this.dateOpenedOrDisbursed = dateOpenedOrDisbursed;
    }
    ...
    @JsonProperty("HighCreditOrSanctionedAmount")
    public Long getHighCreditOrSanctionedAmount() {
        return highCreditOrSanctionedAmount;
    }

    @JsonProperty("HighCreditOrSanctionedAmount")
    public void setHighCreditOrSanctionedAmount(Long highCreditOrSanctionedAmount) {
        this.highCreditOrSanctionedAmount = highCreditOrSanctionedAmount;
    }
