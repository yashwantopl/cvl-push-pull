 ...
 * @Date 01-Aug-2019
 */
public class GstUsersInsertedResponse  implements Serializable{
	...
	public GstUsersInsertedResponse(Long id, String mobile, String email, Boolean isEmailSent, Date emailSentDate,String pan,String borrowerName,String circle,String module,String branchCode,String branch,String cif,String accountNo,String facility,String explosureRsInCR,String gstPanStatus,String remarks,Boolean isGstDataRetrieved,Long uploadedBy,Integer amountOfLoan) {
		super();
		this.id = id;
		this.mobile = mobile;
		this.email = email;
	...
	public GstUsersInsertedResponse(Long id, String mobile, String email, Boolean isEmailSent, Date emailSentDate,String pan,String gstPanStatus,String remarks,Boolean isGstDataRetrieved,Long uploadedBy,Integer amountOfLoan) {
		super();
		this.id = id;
		this.mobile = mobile;
		this.email = email;
	...
	public GstUsersInsertedResponse() {
