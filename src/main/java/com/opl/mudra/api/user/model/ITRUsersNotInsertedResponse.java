 ...
 *
 */
public class ITRUsersNotInsertedResponse  implements Serializable{
	...
	public ITRUsersNotInsertedResponse(String mobile, String email,String pan ,String message) {
		this.mobile = mobile;
		this.email = email;
		this.message = message;
		this.pan = pan;
	}
	public ITRUsersNotInsertedResponse() {
	}
