 ...
 * 
 */
public class EclgsGstUsersNotInsertedResponse  implements Serializable{
	...
	public EclgsGstUsersNotInsertedResponse(String mobile, String email,String pan ,String message) {
		this.mobile = mobile;
		this.email = email;
		this.message = message;
		this.pan = pan;
	}
	public EclgsGstUsersNotInsertedResponse() {
	}
