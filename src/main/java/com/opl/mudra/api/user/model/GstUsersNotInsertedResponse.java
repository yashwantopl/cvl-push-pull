 ...
 * @Date 01-Aug-2019
 */
public class GstUsersNotInsertedResponse  implements Serializable{
	...
	public GstUsersNotInsertedResponse(String mobile, String email,String pan ,String message) {
		this.mobile = mobile;
		this.email = email;
		this.message = message;
		this.pan = pan;
	}
	public GstUsersNotInsertedResponse() {
	}
