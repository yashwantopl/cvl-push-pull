 ...
 *
 */
public class MCAUsersNotInsertedResponse  implements Serializable{
	...
	public MCAUsersNotInsertedResponse(String mobile, String email,String pan ,String message,String cin,String companyName) {
		this.mobile = mobile;
		this.email = email;
		this.message = message;
		this.pan = pan;
	...
	public MCAUsersNotInsertedResponse() {
	}
