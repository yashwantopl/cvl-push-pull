 ...
 *
 */
public class HunterRequestDataResponse {
...
private Double loanAmount;
	...
	/**
	 * @param establishmentDate the establishmentDate to set
	 */
	...
	/**
	 * @param companyPincode the companyPincode to set
	 */
	...
	/**
	 * @param companyBankAccount the companyBankAccount to set
	 */
