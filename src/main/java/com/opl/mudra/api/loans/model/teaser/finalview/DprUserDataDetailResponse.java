 ...
 *
 */
public class DprUserDataDetailResponse implements Serializable{
	...
	public String getAbsenceCivicRestrictions() {
		return absenceCivicRestrictions;
	}
	...
	public String getProximityToSourceRawMaterials() {
		return proximityToSourceRawMaterials;
	}
	...
	public String getSpecialFeaturesProductsAndServices() {
		return specialFeaturesProductsAndServices;
	}
	...
	public String getWhetherClearanceIsObtainedFromPollutionControlAuthority() {
		return whetherClearanceIsObtainedFromPollutionControlAuthority;
	}

	public void setWhetherClearanceIsObtainedFromPollutionControlAuthority(
			String whetherClearanceIsObtainedFromPollutionControlAuthority) {
	...
	public String getWorking_Days_in_month__number() {
		return working_Days_in_month__number;
	}
	...
	public DprUserDataDetailResponse() {
		super();
	}

	public DprUserDataDetailResponse(String absenceCivicRestrictions, String competitiveLandscape,
			String globalScenario, String keyPlayers, String labourAvailability, String manufacturingProcess,
			String marketForTheProduct, String marketGrowth, String marketNeeds, String marketTrends,
			String marketsCurrentlyServed, String nationalScenario, String otherAvailability, String otherBenefits,
			String powerAvailability, String projectJjustification, String proximityToSourceRawMaterials,
			String shiftsInDayNumber, String specialFeaturesProductsAndServices, String targetMarketStrategy,
			String technicalKnowHow, String transportAvailability, String waterAvailability,
			String whetherClearanceIsObtainedFromPollutionControlAuthority, String working_Days_in_month__number) {
		super();
		this.absenceCivicRestrictions = absenceCivicRestrictions;
		this.competitiveLandscape = competitiveLandscape;
		this.globalScenario = globalScenario;
