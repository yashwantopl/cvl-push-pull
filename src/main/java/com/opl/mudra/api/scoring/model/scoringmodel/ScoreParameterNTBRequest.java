...
public class ScoreParameterNTBRequest implements Serializable {
	...
	private Double itrSalaryIncomeAvg;
	...
	public Double getItrSalaryIncomeAvg() {
		return itrSalaryIncomeAvg;
	}

	public void setItrSalaryIncomeAvg(Double itrSalaryIncomeAvg) {
		this.itrSalaryIncomeAvg = itrSalaryIncomeAvg;
	}
	...
	public String toString() {
		return "ScoreParameterNTBRequest [isWorkingExperience=" + isWorkingExperience
				...
				", totalIncomeItr=" + totalIncomeItr + ", itrSalaryIncomeAvg=" + itrSalaryIncomeAvg
				+ "]";
	}
