...
public class ScoreParameterResult {
    ...
    private String pat_net_sales_text;
    private String pat_net_sales_code;
    private Double pat_net_sales_score;
    private Double pat_net_sales_max_score;

    private String statutory_compliance_text;
    private String statutory_compliance_code;
    private Double statutory_compliance_score;
    private Double statutory_compliance_max_score;

    private String payment_records_with_lenders_text;
    private String payment_records_with_lenders_code;
    private Double payment_records_with_lenders_score;
    ...
    public void setQualityOfFinishedGoodsInventory_obtained_score(Double qualityOfFinishedGoodsInventory_obtained_score) {
    ...
    public void setNo_of_cheques_bounced_last_six_month_obtained_score(Double no_of_cheques_bounced_last_six_month_obtained_score) {
    ...
    public void setNo_of_cheques_bounced_last_six_month_max_score(Double no_of_cheques_bounced_last_six_month_max_score) {
    ...
    public String getPat_net_sales_text() {
        return pat_net_sales_text;
    }

    public void setPat_net_sales_text(String pat_net_sales_text) {
        this.pat_net_sales_text = pat_net_sales_text;
    }

    public String getPat_net_sales_code() {
        return pat_net_sales_code;
    }

    public void setPat_net_sales_code(String pat_net_sales_code) {
        this.pat_net_sales_code = pat_net_sales_code;
    }

    public Double getPat_net_sales_score() {
        return pat_net_sales_score;
    }

    public void setPat_net_sales_score(Double pat_net_sales_score) {
        this.pat_net_sales_score = pat_net_sales_score;
    }

    public Double getPat_net_sales_max_score() {
        return pat_net_sales_max_score;
    }

    public void setPat_net_sales_max_score(Double pat_net_sales_max_score) {
        this.pat_net_sales_max_score = pat_net_sales_max_score;
    }

    public String getStatutory_compliance_text() {
        return statutory_compliance_text;
    }

    public void setStatutory_compliance_text(String statutory_compliance_text) {
        this.statutory_compliance_text = statutory_compliance_text;
    }

    public String getStatutory_compliance_code() {
        return statutory_compliance_code;
    }

    public void setStatutory_compliance_code(String statutory_compliance_code) {
        this.statutory_compliance_code = statutory_compliance_code;
    }

    public Double getStatutory_compliance_score() {
        return statutory_compliance_score;
    }

    public void setStatutory_compliance_score(Double statutory_compliance_score) {
        this.statutory_compliance_score = statutory_compliance_score;
    }

    public Double getStatutory_compliance_max_score() {
        return statutory_compliance_max_score;
    }

    public void setStatutory_compliance_max_score(Double statutory_compliance_max_score) {
        this.statutory_compliance_max_score = statutory_compliance_max_score;
    }

    public String getPayment_records_with_lenders_text() {
        return payment_records_with_lenders_text;
    }

    public void setPayment_records_with_lenders_text(String payment_records_with_lenders_text) {
        this.payment_records_with_lenders_text = payment_records_with_lenders_text;
    }

    public String getPayment_records_with_lenders_code() {
        return payment_records_with_lenders_code;
    }

    public void setPayment_records_with_lenders_code(String payment_records_with_lenders_code) {
        this.payment_records_with_lenders_code = payment_records_with_lenders_code;
    }

    public Double getPayment_records_with_lenders_score() {
        return payment_records_with_lenders_score;
    }

    public void setPayment_records_with_lenders_score(Double payment_records_with_lenders_score) {
        this.payment_records_with_lenders_score = payment_records_with_lenders_score;
    }

    public Double getPayment_records_with_lenders_max_score() {
        return payment_records_with_lenders_max_score;
    }
