...
public class DateComparatorAscTime3 implements Comparator<DataMappingProjectedSales> {

    private final Logger logger = LoggerFactory.getLogger(DateComparatorAscTime3.class);
