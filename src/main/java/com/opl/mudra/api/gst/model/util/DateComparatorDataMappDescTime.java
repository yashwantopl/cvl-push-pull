...
public class DateComparatorDataMappDescTime implements Comparator<DataMappingProjectedSales> {

    private final Logger logger = LoggerFactory.getLogger(DateComparatorDataMappDescTime.class);
