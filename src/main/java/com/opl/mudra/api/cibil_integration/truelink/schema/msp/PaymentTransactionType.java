...
import com.opl.mudra.api.cibil_integration.truelink.schema.database.tcps.enumerations.PaymentProcessorType;
import com.opl.mudra.api.cibil_integration.truelink.schema.database.tcps.enumerations.PaymentTransStatusType;
...
public class PaymentTransactionType {
    ...
    @XmlSchemaType(name = "string")
    protected com.opl.mudra.api.cibil_integration.truelink.schema.database.tcps.enumerations.CreditCardType creditCardType;
    @XmlElement(name = "CreditCard", required = true)
    protected com.opl.mudra.api.cibil_integration.truelink.schema.msp.CreditCardType creditCard;
     ...
     * @return
     *     possible object is
     *     {@link com.opl.mudra.api.cibil_integration.truelink.schema.database.tcps.enumerations.CreditCardType }
     *     
     */
    public com.opl.mudra.api.cibil_integration.truelink.schema.database.tcps.enumerations.CreditCardType getCreditCardType() {
     ...
     *     
     */
    public void setCreditCardType(com.opl.mudra.api.cibil_integration.truelink.schema.database.tcps.enumerations.CreditCardType value) {
     ...
     * @return
     *     possible object is
     *     {@link com.opl.mudra.api.cibil_integration.truelink.schema.msp.CreditCardType }
     *     
     */
    public com.opl.mudra.api.cibil_integration.truelink.schema.msp.CreditCardType getCreditCard() {
        return creditCard;
    }
     ...
     *     
     */
    public void setCreditCard(com.opl.mudra.api.cibil_integration.truelink.schema.msp.CreditCardType value) {
