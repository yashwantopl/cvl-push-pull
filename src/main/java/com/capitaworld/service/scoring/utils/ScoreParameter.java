package com.capitaworld.service.scoring.utils;
...
public class ScoreParameter {
    ...
    public static List<String> getSalariedIgnorelist() {
		return SALARIED_IGNORELIST;
	}

	public static List<String> getSelfemployedIgnorelist() {
		return SELFEMPLOYED_IGNORELIST;
	}
    ...
    public final class MudraLoan{
    	private MudraLoan() {}
    	
    	// PARAMETER MSME starts
    	    public static final String CUSTOMER_ASSOCIATE_CONCERN_ML = "CUSTOMER_ASSOCIATE_CONCERN_ML";
    	    public static final String CIBIL_TRANSUNION_SCORE_ML = "CIBIL_TRANSUNION_SCORE_ML";
    	    public static final String TOL_TNW_ML = "TOL_TNW_ML";
    	    public static final String NO_OF_CUSTOMER_ML = "NO_OF_CUSTOMER_ML";
    	    ...
    	    public static final String FACTORY_PREMISES_ML = "FACTORY_PREMISES_ML";
    	    public static final String YEARS_IN_BUSINESS_ML = "YEARS_IN_BUSINESS_ML";

    	    public static final String PAST_YEAR_TURNOVER_ML = "PAST_YEAR_TURNOVER_ML";
    	    public static final String NO_OF_CHEQUES_BOUNCED_ML = "NO_OF_CHEQUES_BOUNCED_ML";
    	    public static final String NO_OF_CHEQUES_BOUNCED_LAST_SIX_MONTH_ML = "NO_OF_CHEQUES_BOUNCED_LAST_SIX_MONTH_ML";
    	    public static final String PAT_NET_SALES_RATIO_ML= "PAT_NET_SALES_RATIO_ML";
    	    public static final String PAYMENT_RECORDS_WITH_LENDERS_ML = "PAYMENT_RECORDS_WITH_LENDERS_ML";
    	    
    	    
    	    // Payment record with Lenders
    	    //Industry 
        	// PARAMETER MSME ends
    	    
    	    
    	    // MUDRA added  PARAMETERS starts
    	    
    	    public static final String ID_PROOF_ML = "ID_PROOF_ML";
    	    public static final String NUMBER_OF_DEPENDENTS_ML = "NUMBER_OF_DEPENDENTS_ML";
    	    public static final String RESIDING_AT_THE_SAME_ADDRESS_ML="RESIDING_AT_THE_SAME_ADDRESS_ML";
    	    public static final String CERTIFICATION_ML="CERTIFICATION_ML";
    	    public static final String UDYOG_AADHAR_ML="UDYOG_AADHAR_ML";
    	    public static final String ITR_RETURN_FILED_ML="ITR_RETURN_FILED_ML";
    	    public static final String MAIN_DIRECTOR_CATEGORY_ML="MAIN_DIRECTOR_CATEGORY_ML";
    	    public static final String TYPE_OF_ACTIVITY_ML="TYPE_OF_ACTIVITY_ML";
    	    public static final String RELATIONSHIP_WITH_BANK_ML="RELATIONSHIP_WITH_BANK_ML";
    	    public static final String RELATIONSHIP_WITH_BANK_COMBINED_ML="RELATIONSHIP_WITH_BANK_COMBINED_ML";
    	    public static final String COVERED_UNDER_DIFF_SCHEMES_ML="COVERED_UNDER_DIFF_SCHEMES_ML";
    	    public static final String MARKETING_ARRANGEMENT_FOR_FINISHED_GOODS_ML ="MARKETING_ARRANGEMENT_FOR_FINISHED_GOODS_ML";
    	    public static final String REGISTRATION_WITH_GOVERNMENT_AUTHORITIES_ML ="REGISTRATION_WITH_GOVERNMENT_AUTHORITIES_ML";
    	    public static final String REGISTRATION_WITH_GOVERNMENT_AUTHORITIES_COMBINED_ML ="REGISTRATION_WITH_GOVERNMENT_AUTHORITIES_COMBINED_ML";
    	    public static final String OTHER_SOURCE_OF_INCOME_ML ="OTHER_SOURCE_OF_INCOME_ML";
    	    
    	    public static final String BUSINESS_PROSPECTS_OF_THE_ACTIVITY_TO_BE_UNDERTAKEN_ML ="BUSINESS_PROSPECTS_OF_THE_ACTIVITY_TO_BE_UNDERTAKEN_ML";
    	    public static final String ACCESS_TO_INPUTS_ML ="ACCESS_TO_INPUTS_ML";
    	    public static final String CREDIT_SUMMATION_ML = "CREDIT_SUMMATION_ML";
    	    public static final String DISTANCE_BETWEEN_WORKPLACE_AND_RESIDENCE_ML = "DISTANCE_BETWEEN_WORKPLACE_AND_RESIDENCE_ML";
    	    public static final String EMPLOYMENT_GENERATION_ML = "EMPLOYMENT_GENERATION_ML";
    	    public static final String PROMOTERS_CONTRIBUTION_ML = "PROMOTERS_CONTRIBUTION_ML";
    	    
    	    public static final String TENURE_ML ="TENURE_ML";
    }

    public static final class MudraLoansFinancialType
    {
        private MudraLoansFinancialType(){
            // nothing to do.
        }
        public static final Integer AUDITED_ITR =1;
        public static final Integer NO_ITR=2;
    }
}
